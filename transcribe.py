...
def transcribe(
    ...
    **decode_options,
    ...
    ##! DECODING FILE PROGRESS BAR INITIATION
    ...
    def decode_with_fallback(
        segment: torch.Tensor, callback: Optional[callable] = None
    ) -> DecodingResult:
        temperatures = (
        ...
        for t in temperatures:
            ...
            decode_result = model.decode(segment, options, callback=callback)
    ...
    ##! MAIN LOOP LOGIC FOR TRANSCRIPTION, PRE-WORD ALIGNMENT
    # with tqdm.tqdm(total=content_frames, unit="frames", disable=False) as pbar:
    ...
    while seek < content_frames:
        ...
        result: DecodingResult = decode_with_fallback(mel_segment, callback=callback)
        ...
        if len(consecutive) > 0:
            ...
            # print("if statement in transcribe.py at line 277 reached")
            ...
            # print("else statement in transcribe.py at line 313 reached")
